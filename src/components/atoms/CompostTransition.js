...
class CompostTransition extends React.Component {
  ...
  render() {
    ...
    if(this.state.temperature >= 10 && this.state.temperature <= 40 && this.state.day >= 3 && this.state.day <= 14 || this.state.temperature >= 10 && this.state.temperature <= 30 && this.state.day < 3) {
